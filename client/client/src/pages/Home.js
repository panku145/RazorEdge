...
const Home = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    Axios.get("https://backend.razoredgeanalytics.com/home-get").then((res) => setSolutionData(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/why-razor-edge-get").then((res) => setWhyRazorEdge(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/solution2-get/get-all").then((res) => setData(res.data));
  }, []);
            ...
            <div className="row product-comp-rw">
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${value.sol1Fifthcard1Image}`}
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${value.sol1Fifthcard2Image}`}
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${value.sol1Fifthcard3Image}`}
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${value.sol1Fifthcard4Image}`}
