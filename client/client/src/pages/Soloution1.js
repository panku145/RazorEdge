            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6">
                <div className="integration-img-container">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1ZeroImage}`}
            ...
            <div className="row">
              <div className=" col-lg-6 col-md-6 integration-data-col">
                <div className="bullet-img-sec">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1FirstImage}`}
                    className="data"
                    alt="data"
                  />
                </div>
            ...
            <div className="row get-more-row">
              ...
              >
                <div className="get-more-inner-col product-first-comp py-3">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1Thirdcard1Image}`}
                    className="connect"
                    alt="connect"
                  />
              ...
              >
                <div className="get-more-inner-col product-first-comp py-3">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1Thirdcard2Image}`}
                    className="connect"
                    alt="connect"
                  />
              ...
              >
                <div className="get-more-inner-col product-first-comp py-3">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1Thirdcard3Image}`}
                    className="connect"
                    alt="connect"
                  />
              ...
              >
                <div className="get-more-inner-col product-first-comp py-3">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1Thirdcard4Image}`}
                    className="connect"
                    alt="connect"
                  />
          ...
          <div className="container">
            <div className="row">
              <div className=" col-lg-6 col-md-6 integration-data-col">
                <div className="bullet-img-sec">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1FourthImage}`}
          ...
          <div className="container">
            <div className="row">
              ...
              <div className=" col-lg-6 col-md-6 py-3 m-auto">
                <div className="bullet-img-sec">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${solution1.sol1FifthImage}`}
                    className="resources"
                    alt="resources"
                  />
                </div>
