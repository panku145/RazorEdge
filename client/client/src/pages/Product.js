...
const Product = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const get = async () => {
      const res = await Axios.get("https://backend.razoredgeanalytics.com/product-get/product/" + id);
      setProduct(res.data);
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6">
                <div className="integration-img-container">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proFirstImage}`}
            ...
            <div className="row">
              <div className=" col-lg-6 col-md-6 m-auto integration-data-col">
                <div className="bullet-img-sec">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proSecondImage}`}
                    className="data"
                    alt="data"
                  />
                </div>
          ...
          <div className="container">
            <div className="row">
              <div className=" col-lg-6 col-md-6 pb-3 integration-data-col">
                <div className="bullet-img-sec">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proThirdImage}`}
            ...
            <div className="row product-comp-rw">
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proFourthCards1img}`}
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proFourthCards2img}`}
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proFourthCards3img}`}
              ...
              >
                <div className="product-first-img">
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${product.proFourthCards4img}`}
