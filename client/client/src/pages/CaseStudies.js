...
const CaseStudies = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0); 
    Axios.get("https://backend.razoredgeanalytics.com/casestudy-page-get").then((res) => setCaseStudyPage(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/case-studies-get").then((res) => setCaseStudies(res.data));
  }, []);
