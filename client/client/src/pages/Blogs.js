...
const Blogs = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    Axios.get("https://backend.razoredgeanalytics.com/blogPage-get").then((res) => setBlogpage(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/blogs-get").then((res) => setBlog(res.data));
  }, []);
