          ...
          <div className="row">
            <div className=" col-lg-6 col-md-6 integration-data-col pb-3">
              <div className="bullet-img-sec">
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${data.sol2FirstImage}`}
                  className="whyUs"
                  alt="whyUs"
                />
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className=" col-lg-6 col-md-6 integration-data-col">
              <div className="bullet-img-sec">
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${data.sol2ThirdImage}`}
          ...
          <div className="row product-comp-rw">
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${data.sol1Fifthcard1Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${data.sol1Fifthcard2Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${data.sol1Fifthcard3Image}`}
            ...
            >
              <div className="product-first-img">
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${data.sol1Fifthcard4Image}`}
