...
const Disclaimer = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    Axios.get("https://backend.razoredgeanalytics.com/disclaimers").then((res) => setData(res.data));
  }, []);
...
//     window.scrollTo(0, 0);
//     const data = async() => {
//       Axios.get("https://backend.razoredgeanalytics.com/disclaimer").then((res) =>
//         setData(res.data)
//       );
//     }
//     data();
