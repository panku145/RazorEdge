...
const Career = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    Axios.get("https://backend.razoredgeanalytics.com/careers").then((res) => setCareer(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/development-jobs").then((res) => setDevelopment(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/management-jobs").then((res) => setManagement(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/operation-jobs").then((res) => setOperation(res.data));
  }, []);
      ...
      {career.map((value, index) => (
        <div key={index}>
          ...
          <div className="career-img-container">
            <img
              src={`https://backend.razoredgeanalytics.com/images/${value.Sec1.img}`}
