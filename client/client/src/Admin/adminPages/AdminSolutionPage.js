...
const AdminSolutionPage = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const get = async () => {
      const res = await Axios.get("https://backend.razoredgeanalytics.com/solution2-get/" + id);
      setkey(res.data._id);
      setData(res.data);
  ...
  const updateData = async (e) => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/solution2-update", formData);
              ...
              <div className=" col-lg-6 col-md-6 integration-data-col pb-3">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${sol2FirstImage1}`}
                      className="whyUs"
                      alt="whyUs"
                    />
                  )}
              ...
              <div className=" col-lg-6 col-md-6 integration-data-col">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${sol2ThirdImage1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${sol1Fifthcard1Image1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${sol1Fifthcard2Image1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${sol1Fifthcard3Image1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${sol1Fifthcard4Image1}`}
