...
const AdminRazorEdgePage = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const getData = async () => {
      await Axios.get("https://backend.razoredgeanalytics.com/wreaccordian").then((res) => setAccordian(res.data));
      const res = await Axios.get("https://backend.razoredgeanalytics.com/why-razor-edge-get");
  ...
  const updateData = async (e) => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/why-razor-edge-update", formData);
    // navigate("/admin-why-razor-edge");
          ...
          <div className="container d-flex justify-content-center">
            <div className="why-us-img-container text-center w-50">
              {/* {update ? (
                ...
                <img
                  src={`https://backend.razoredgeanalytics.com/images/${WRESec1image1}`}
                  className="whyUs"
                  alt="whyUs"
                />
              )} */}
                ...
                update ? (
                  ...
                  <div className="player-wrapper">
                    <ReactPlayer
                      playing={true}
                      controls={true}
                      light={`https://backend.razoredgeanalytics.com/images/video-img.jpg`}
                      url={`https://backend.razoredgeanalytics.com/images/${WRESec1image1}`}
                    />
                  </div>
                )
              ) : update ? (
            ...
            <div className="col-md-2">
              <div className="problem-img-container">
                {update ? (
                  ...
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${WRESec2leftimg1}`}
                    className="problem1"
                    alt="problem1"
                  />
                )}
            ...
            <div className="col-md-2">
              <div className="problem-img-container">
                {update ? (
                  ...
                  <img
                    src={`https://backend.razoredgeanalytics.com/images/${WRESec2rightimg1}`}
                    className="problem1"
                    alt="problem1"
                  />
                )}
                        ...
                        <div className=" col-lg-6 m">
                          <div className="bullet-img-sec">
                            {update ? (
                              ...
                              <img
                                src={`https://backend.razoredgeanalytics.com/images/${WRESec3SliderImage1}`}
