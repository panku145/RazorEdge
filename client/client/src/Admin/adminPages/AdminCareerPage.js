...
//   useEffect(() => {
//     Axios.get("https://backend.razoredgeanalytics.com/career").then((res) =>
//     setCareer(res.data)
//     );
//   }, []);
...
const AdminCareerPage = () => {
  ...
  useEffect(() => {
    ...
    const get = async () => {
      ...
      await Axios.get("https://backend.razoredgeanalytics.com/development-jobs").then((res) =>
        setDevelopment(res.data)
      );

      await Axios.get("https://backend.razoredgeanalytics.com/management-jobs").then((res) =>
        setManagement(res.data)
      );

      await Axios.get("https://backend.razoredgeanalytics.com/operation-jobs").then((res) => setOperation(res.data));
      ...
      const res = await Axios.get("https://backend.razoredgeanalytics.com/careers");
      res.data.map((value) => {
  ...
  //   await Axios.put("https://backend.razoredgeanalytics.com/career", formData);
  ...
  const updateData = async () => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/careers", data);
    window.location.reload();
  };
    ...
    <>
      ...
      <div className="career-img-container">
        {update ? (
          ...
          <img
            src={`https://backend.razoredgeanalytics.com/images/${sec1img1}`}
