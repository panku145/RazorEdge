...
const AdminSolution1Page = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const get = async () => {
      const res = await Axios.get("https://backend.razoredgeanalytics.com/solution1-get/" + id);
      setData(res.data);
  ...
  const updateData = async (e) => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/solution1-update", formData);
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="integration-img-container">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1ZeroImage1}`}
                ...
                <div className=" col-lg-6 col-md-6 integration-data-col">
                  <div className="bullet-img-sec">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1FirstImage1}`}
                        className="data"
                        alt="data"
                      />
                    )}
                ...
                <div className="col-md-3 py-3">
                  <div className="get-more-inner-col product-first-comp py-3">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1Thirdcard1Image1}`}
                        className="connect"
                        alt="connect"
                      />
                    )}
                ...
                <div className="col-md-3 ">
                  <div className="get-more-inner-col product-first-comp py-3">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1Thirdcard2Image1}`}
                        className="connect"
                        alt="connect"
                      />
                    )}
                ...
                <div className="col-md-3 py-3">
                  <div className="get-more-inner-col product-first-comp py-3">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1Thirdcard3Image1}`}
                        className="connect"
                        alt="connect"
                      />
                    )}
                ...
                <div className="col-md-3 py-3">
                  <div className="get-more-inner-col product-first-comp py-3">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1Thirdcard4Image1}`}
                        className="connect"
                        alt="connect"
                      />
                    )}
                ...
                <div className=" col-lg-6 col-md-6 integration-data-col">
                  <div className="bullet-img-sec">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1FourthImage1}`}
                ...
                <div className=" col-lg-6 col-md-6 py-3 m-auto">
                  <div className="bullet-img-sec">
                    {update ? (
                      ...
                      <img
                        src={`https://backend.razoredgeanalytics.com/images/${sol1FifthImage1}`}
                        className="resources"
                        alt="resources"
                      />
                    )}
