...
const AdminHeader = () => {
  ...
  useEffect(() => {
    Axios.get("https://backend.razoredgeanalytics.com/header").then((res) => setHeader(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/solution2-get").then((res) => setSolutionPages(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/solution1-get").then((res) => setSolution1Pages(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/product-get").then((res) => setProductPages(res.data));
  }, []);
