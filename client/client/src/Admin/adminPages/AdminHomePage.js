...
const AdminHomePage = (props) => {
  ...
  const updateData = async (e) => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/home-update", formData, config);
                        ...
                        update ? (
                          ...
                          <div className="player-wrapper">
                            <ReactPlayer
                              ...
                              url={`https://backend.razoredgeanalytics.com/images/${herovideoimage1}`}
                            />
                          </div>
                        )
                      ) : update ? (
              ...
              <div className=" col-lg-6 m-auto">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${bulletimage1}`}
                  ...
                  <div className="col-md-6 m-auto text-center ">
                    <div className="solution-img-container">
                      {update ? (
                        ...
                        <img
                          src={`https://backend.razoredgeanalytics.com/images/${solutionimage1}`}
                          className="Solution"
                          alt="Solution"
                        />
                      )}
              ...
              <div className="our-solution-head ">
                ...
                <div className="product-img-conatiner">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proSecmainimage1}`}
                      className="product"
                      alt="product"
                    />
                  )}
