...
const AdminProductPage = () => {
  ...
  //   await Axios.put("https://backend.razoredgeanalytics.com/product-update", formData);
  ...
  const updateData = async (e) => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/product-update", data);
    // window.location.reload();
              ...
              <div className="col-lg-6 col-md-6">
                <div className="integration-img-container">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proFirstImage1}`}
                      className="VideoImg"
                      alt="VideoImg"
                    />
                  )}
              ...
              <div className=" col-lg-6 col-md-6 integration-data-col">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proSecondImage1}`}
                      className="VideoImg"
                      alt="VideoImg"
                    />
                  )}
              ...
              <div className=" col-lg-6 col-md-6 pb-3 integration-data-col">
                <div className="bullet-img-sec">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proThirdImage1}`}
                      className="VideoImg"
                      alt="VideoImg"
                    />
                  )}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proFourthCards1img1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proFourthCards2img1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proFourthCards3img1}`}
              ...
              <div className="col-md-3 py-3">
                <div className="product-first-img">
                  {update ? (
                    ...
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${proFourthCards4img1}`}
