...
const PartnersPage = (props) => {
  ...
  useEffect(() => {
    Axios.get("https://backend.razoredgeanalytics.com/partner-service").then((res) => {
  ...
  const updateData = async (e) => {
    ...
    Axios.put("https://backend.razoredgeanalytics.com/partners", data).then((res) => window.location.reload());
  };
