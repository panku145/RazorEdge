...
const ClientPage = (props) => {
  ...
  useEffect(() => {
    Axios.get("https://backend.razoredgeanalytics.com/clientgallery").then((res) => setClientGallery(res.data));

    Axios.get("https://backend.razoredgeanalytics.com/clientPage").then((res) =>
      res.data.map((value) => {
  ...
  const updateData = () => {
    ...
    Axios.put("https://backend.razoredgeanalytics.com/clientPage", data).then((res) => window.location.reload());
  };
