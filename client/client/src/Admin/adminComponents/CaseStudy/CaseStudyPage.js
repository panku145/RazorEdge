...
const CaseStudyPage = (props) => {
  ...
  useEffect(() => {
    Axios.get("https://backend.razoredgeanalytics.com/case-studies-get").then((res) => setCaseStudy(res.data));
  }, []);
  ...
  const updateData = async () => {
    ...
    Axios.post("https://backend.razoredgeanalytics.com/casestudy-page-update", data).then((res) =>
