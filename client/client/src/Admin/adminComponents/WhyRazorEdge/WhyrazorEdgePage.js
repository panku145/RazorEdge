...
const WhyrazorEdgePage = (props) => {
  ...
  useEffect(() => {
    Axios.get("https://backend.razoredgeanalytics.com/wreaccordian").then((res) => setAccordian(res.data));

    const getData = async () => {
      let res = await Axios.get("https://backend.razoredgeanalytics.com/why-razor-edge-get");
  ...
  const updateData = async (e) => {
    ...
    await Axios.put("https://backend.razoredgeanalytics.com/why-razor-edge-update", formData, config);
    navigate("/admin-why-razor-edge");
