...
export default function GetCard(props) {
  ...
  const deleteData = () => {
    Axios.post("https://backend.razoredgeanalytics.com/delete", { _id: props.id }).then((res) =>
  ...
  const updateData = () => {
    ...
    Axios.post("https://backend.razoredgeanalytics.com/update", data).then((res) => window.location.reload());
  };
