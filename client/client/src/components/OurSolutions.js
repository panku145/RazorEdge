...
const OurSolutions = (props) => {
  ...
  useEffect(() => {
    Axios.get("https://backend.razoredgeanalytics.com/homeaccordian").then((res) => setAccordian(res.data));
  }, []);
              ...
              <div className="row">
                ...
                <div className="col-md-6 m-auto text-center ">
                  <div className="solution-img-container">
                    <img
                      src={`https://backend.razoredgeanalytics.com/images/${props.image}`}
